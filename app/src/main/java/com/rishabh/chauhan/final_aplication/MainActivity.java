...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        R_0 = (Button) findViewById(R.id.R_0);
        R_1 = (Button) findViewById(R.id.R_1);
        R_2 = (Button) findViewById(R.id.R_2);
        R_3 = (Button) findViewById(R.id.R_3);
        R_4 = (Button) findViewById(R.id.R_4);
        R_5 = (Button) findViewById(R.id.R_5);
        R_6 = (Button) findViewById(R.id.R_6);
        R_7 = (Button) findViewById(R.id.R_7);
